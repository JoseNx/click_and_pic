...
//Ejecucion
if (isset($borrar)) {
    foreach ($_POST['adminEliminar'] as $usuarioDato) {
        $consultaDevolver = "DELETE FROM `usuario` WHERE login='$usuarioDato'";
        $conexion->query($consultaDevolver);
    }
    header("Location: borrarAdmin.php");
...
<html lang = "Es-es">
    ...
    <head>
        ...
        <link rel = "stylesheet" type = "text/css" href = "../css/borrarAdmin.css" />
                    ...
                    <tbody>
                        <?php foreach ($listaAdmin as $adminDato) {
                            ...
                            <tr>
                                ...
                                <td><?php echo "*************" ?></td>
                                <td><input type="checkbox" name="adminEliminar[]" value="<?php echo $adminDato['login'] ?>"/></td>
                            </tr>
                        </tbody>
