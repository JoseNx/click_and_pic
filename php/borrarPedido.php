...
//Ejecucion
if (isset($borrar)) {
    foreach ($_POST['pedidoEliminar'] as $PedidoDato) {
        $consultaDevolver = "DELETE FROM `pedido` WHERE codigo_pedido='$PedidoDato'";
...
<html lang = "Es-es">
    ...
    <head>
        ...
        <link rel = "stylesheet" type = "text/css" href = "../css/borrarPedido.css" />
    ...
    <body>
        ...
        <a  href="../php/opcionesPedido.php"><img id="atras" src="../assets/atras.svg"></a>
                    ...
                    <tbody>
                        <?php foreach ($listaPedido as $PedidoDato) {
                            ...
                            <tr>
                                ...
                                <td><input type="checkbox" name="pedidoEliminar[]" value="<?php echo $PedidoDato['codigo_pedido'] ?>"/></td>
                            </tr>
                        </tbody>
