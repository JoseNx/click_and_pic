...
//Ejecucion
if (isset($borrar)) {
    foreach ($_POST['productoEliminar'] as $productoDato) {
        $consultaDevolver = "DELETE FROM `producto` WHERE nombre_corto='$productoDato'";
...
<html lang = "Es-es">
    ...
    <head>
        ...
        <link rel = "stylesheet" type = "text/css" href = "../css/borrarProducto.css" />
                    ...
                    <tbody>
                        <?php foreach ($listaProducto as $productoDato) {
                            ...
                            <tr>
                                ...
                                <td><input type="checkbox" name="productoEliminar[]" value="<?php echo $productoDato['nombre_corto'] ?>"/></td>
                            </tr>
                            </tr>
                        </tbody>
