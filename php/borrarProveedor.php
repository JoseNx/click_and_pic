...
//Ejecucion
if (isset($borrar)) {
    foreach ($_POST['proveedorEliminar'] as $proveedorDato) {
        $consultaDevolver = "DELETE FROM `proveedor` WHERE codigo_proveedor='$proveedorDato'";
        $conexion->query($consultaDevolver);
    }
    header("Location: borrarProveedor.php");
...
<html lang = "Es-es">
    ...
    <head>
        ...
        <link rel = "stylesheet" type = "text/css" href = "../css/borrarProveedor.css" />
                    ...
                    <tbody>
                        <?php foreach ($listaProveedor as $proveedorDato) {
                            ...
                            <tr>
                                ...
                                <td><input type="checkbox" name="proveedorEliminar[]" value="<?php echo $proveedorDato['codigo_proveedor'] ?>"/></td>
                            </tr>
                        </tbody>
