...
if (isset($modificar)) {
    if (!empty($contraseñaMod)) {
        if (Admin::Modificar_Contraseña($contraseñaModCod, $loginCuenta) == true) {
...
if (isset($modificar)) {
    if (!empty($nombreMod)) {
        if (Admin::Modificar_Nombre($nombreMod, $loginCuenta) == true) {
            $mensaje = "Cambio/s realizados con exito.";
            $tipo = "mensajeExito";
        } else {
            $mensaje = "No se han podido realizar los cambios.";
...
if (isset($modificar)) {
    if (!empty($apellidoMod)) {
        ...
        if (Admin::Modificar_Apellido($apellidoMod, $loginCuenta) == true) {
            $mensaje = "Cambio/s realizados con exito.";
            $tipo = "mensajeExito";
        } else {
            $mensaje = "No se han podido realizar los cambios.";
...
if (isset($modificar)) {
    if (!empty($correoMod)) {
        if (Admin::Modificar_Correo($correoMod, $loginCuenta) == true) {
            $mensaje = "Cambio/s realizados con exito.";
            $tipo = "mensajeExito";
        } else {
            $mensaje = "No se han podido realizar los cambios.";
    ...
    <body>
        ...
        <div id="formularioRegistro">
            <form class="row g-3" method="post">
                ...
                <div class="mb-3">
                    <label for="exampleFormControlInput1" class="form-label">Login del Admin al que quieres editar</label>
