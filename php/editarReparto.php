...
if (isset($modificar)) {
    if (!empty($nombreProveedor)) {
        if (Reparto::Modificar_Nombre($nombreReparto, $codigoReparto) == true) {
...
if (isset($modificar)) {
    if (!empty($datosProveedor)) {
        if (Reparto::Modificar_Datos($datosReparto, $codigoReparto) == true) {
            $mensaje = "Cambio/s realizados con exito.";
            $tipo = "mensajeExito";
        } else {
            $mensaje = "No se han podido realizar los cambios.";
...
<html lang = "Es-es">
    ...
    <head>
        ...
        <link rel = "stylesheet" type = "text/css" href = "../css/editarReparto.css" />
    ...
    <body>
        ...
        <div id="formularioRegistro">
            <form class="row g-3" method="post">
                ...
                <div class="mb-3">
                    <label for="exampleFormControlInput1" class="form-label">Codigo Repartidor que quiere Editar</label>
                    <input class="form-control" type="text" name="codigoRepartidor" placeholder="camara reflex ultimatum dx" aria-label="default input example">
                </div>
                </br>
                <div class="mb-3">
                    <label for="exampleFormControlInput1" class="form-label">Nombre del Repartidor</label>
                    <input class="form-control" type="text" name="nombreRepartidor" placeholder="++++++" aria-label="default input example">
                </div>
                </br>
                <div class="mb-3">
                    <label for="exampleFormControlInput1" class="form-label">Datos del Repartidor</label>
                    <input class="form-control" name="datosRepartidor" placeholder="+++++++" aria-label="default input example">
                </div>
                </br>
                <div class="col-auto">
