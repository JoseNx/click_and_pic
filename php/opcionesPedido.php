...
$consultaPedido = "SELECT * FROM `pedido` ORDER BY codigo_pedido DESC";
...
<html lang = "Es-es">
    ...
    <head>
        ...
        <link rel = "stylesheet" type = "text/css" href = "../css/opcionesPedido.css" />
    ...
    <body>
        ...
        <div id="botonListaAdministrador">
            <form method="post"><input id="botonListaAdministradorInterior" type="submit" name="listaProducto" value="Lista de Pedidos"></form>
        </div>

        <div id="botonBorrarAdministrador">
            <form method="post"><input id="botonBorrarAdministradorInterior" type="submit" name="borrarProducto" value="Borrar Pedidos"></form>
        </div> 
    ...
    <tbody>
        <?php foreach ($listaPedido as $PedidoDato) {
            ...
            <tr>
                ...
                <td><?php echo $PedidoDato['login'] ?></td>
...
if (isset($borrarProductoBoton)) {
    header("Location: ../php/borrarPedido.php");
}
?>
