...
$listaProveedorBoton = filter_input(INPUT_POST, "listaProveedor");
$editarProveedorBoton = filter_input(INPUT_POST, "editarProveedor");
$borrarProveedorBoton = filter_input(INPUT_POST, "borrarProveedor");
$registrarProveedorBoton = filter_input(INPUT_POST, "registrarProveedor");

//Con esto sacamos la lista de los proveedores.
...
<html lang = "Es-es">
    ...
    <head>
        ...
        <link rel = "stylesheet" type = "text/css" href = "../css/opcionesProveedor.css" />
        <script src = "http://code.jquery.com/jquery-1.11.3.min.js"></script>
        <title>Opciones de proveedor</title>
    </head>
    ...
    <body>
        ...
        <div id="botonListaProveedor">
            <form method="post"><input id="botonListaProveedorInterior" type="submit" name="listaProveedor" value="Lista de Proveedores"></form>
        </div>

        <div id="botonRegistrarProveedor">
            <form method="post"><input id="botonRegistrarProveedorInterior" type="submit" name="registrarProveedor" value="Registrar Proveedor"></form>
        </div>

        <div id="botonEditarProveedor">
            <form method="post"><input id="botonEditarProveedorInterior" type="submit" name="editarProveedor" value="Editar Proveedor"></form>
        </div> 

        <div id="botonBorrarProveedor">
            <form method="post"><input id="botonBorrarProveedorInterior" type="submit" name="borrarProveedor" value="Borrar Proveedor"></form>
        </div> 
...
if (isset($listaProveedorBoton)) {
    ...
    <tbody>
        <?php foreach ($listaProveedor as $proveedorDato) {
            ...
            <tr>
                <td><?php echo $proveedorDato['codigo_proveedor'] ?></td>
                <td><?php echo $proveedorDato['nombre_proveedor'] ?></td>
                <td><?php echo $proveedorDato['datos_proveedor'] ?></td>
            </tr>
        </tbody>
...
if (isset($editarProveedorBoton)) {
    header("Location: ../php/editarProveedor.php");
}

if (isset($borrarProveedorBoton)) {
    header("Location: ../php/borrarProveedor.php");
}

if (isset($registrarProveedorBoton)) {
    header("Location: ../php/registrarProveedor.php");
}
?>
