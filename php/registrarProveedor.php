...
//Registro de admin
if (isset($registro)) {
    if (ValidarDatos::Validar_Nuevo_Proveedor($codigoProveedor,$nombreProveedor,$datosProveedor) == true) {
        if (Proveedor::Proveedor_Nuevo($codigoProveedor,$nombreProveedor,$datosProveedor) == true) {
        ...
        <div id="formularioRegistro">
            <form class="row g-3" method="post">
                ...
                <div class="mb-3">
                    ...
                    <input class="form-control" type="text" name="datosProveedor" placeholder="+++++++" aria-label="default input example">
                </div>
                </br>
               <div class="col-auto">
