...
$codigoReparto = filter_input(INPUT_POST, "codigoReparto");
$nombreReparto = filter_input(INPUT_POST, "nombreReparto");
$datosReparto = filter_input(INPUT_POST, "datosReparto");
...
//Registro de admin
if (isset($registro)) {
    if (ValidarDatos::Validar_Nuevo_Reparto($codigoReparto, $nombreReparto, $datosReparto) == true) {
        if (Reparto::Reparto_Nuevo($codigoReparto, $nombreReparto, $datosReparto) == true) {
            $mensaje = "Proveedor nuevo añadido con exito.";
            $tipo = "mensajeExito";
        } else {
...
<html lang = "Es-es">
    ...
    <head>
        ...
        <link rel = "stylesheet" type = "text/css" href = "../css/registrarReparto.css" />
        <script src = "http://code.jquery.com/jquery-1.11.3.min.js"></script>
        <title>Registro Reparto</title>
    </head>
    ...
    <body>
        ...
        <div id="formularioRegistro">
            <form class="row g-3" method="post">
                ...
                <div class="mb-3">
                    <label for="exampleFormControlInput1" class="form-label">Codigo de Repartidor</label>
                    <input class="form-control" type="text" name="codigoReparto" placeholder="camara reflex ultimatum dx" aria-label="default input example">
                </div>
                </br>
                <div class="mb-3">
                    <label for="exampleFormControlInput1" class="form-label">Nombre del Repartidor</label>
                    <input class="form-control" type="text" name="nombreReparto" placeholder="++++++" aria-label="default input example">
                </div>
                </br>
                <div class="mb-3">
                    <label for="exampleFormControlInput1" class="form-label">Datos del Repartidor</label>
                    <input class="form-control" type="text" name="datosReparto" placeholder="+++++++" aria-label="default input example">
                </div>
                </br>
                <div class="col-auto">
